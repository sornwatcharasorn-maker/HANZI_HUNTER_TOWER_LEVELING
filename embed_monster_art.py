...
FRAME_W, FRAME_H = 144, 95
# **ย่อจาก 176x116 ตอน Micro-Patch ULTIMATE ABYSS (ส.ค. 2026) เพื่อคืนที่ให้ชั้นนั้น**
# กรอบบนจอคือ 109x72 CSS px · 144 จึงยังเกินความกว้างที่ใช้จริงอยู่ 1.32 เท่า
# ซึ่ง **เท่ากับเฟรมฮีโร่ของ v6.5 (1.30x) และทัพเงาของ v6.6 (1.28x) พอดี**
# = เอาก้อนที่ยังสูงผิดแถวลงมาอยู่ระดับเดียวกับเพื่อน ไม่ได้รีดจนต่ำกว่าใคร
# สัดส่วนคงเดิม (144/95 = 1.5158 เทียบ 176/116 = 1.5172 — ต่างกัน 0.1%)
...
# **ต้องเลื่อนตามความสูงเฟรมเสมอ ไม่งั้นสัดส่วน "ตัว/เฟรม" เพี้ยน**
# verify_monsters.js เทียบด้วยสัดส่วน BODY/FRAME_H (92/116 = 0.7931) ไม่ใช่ตัวเลขดิบ
# 92 x 95/116 = 75.34 · 100 x 95/116 = 81.90 → สัดส่วนเท่าเดิมทุกหลักที่วัดได้
BODY, BODY_BOSS = 75.34, 81.90
