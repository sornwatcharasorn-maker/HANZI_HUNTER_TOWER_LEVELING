...
(async () => {
  ...
  // ══ บล็อก 1 · ค่าคงที่ · ทางเข้าสาธารณะ · ไม่เพิ่ม DOM/CSS ════════════════
  {
    ...
    /* ชั้น v8.5 เติมปุ่มที่ 10 (👤 PROFILE) ตามสเปกแถวปุ่มสองคอลัมน์
       สิ่งที่กับดักข้อ 11 ห้ามคือ "ลบ/สลับปุ่มเดิม" ไม่ใช่ห้ามเพิ่ม —
       เคสนี้จึงพลิกมาวัดว่าปุ่มเดิม 9 ใบยังอยู่ครบและมีของใหม่ต่อท้ายเท่านั้น */
    eq('แถวปุ่มล่าง 10 ใบ · ปุ่มเดิม 9 ใบยังอยู่ครบ (กับดักข้อ 11)', dom.btns, 10);
