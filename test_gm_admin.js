...
(async () => {
  ...
  // ═══ 3 · ตารางสด — คอลัมน์ THP · รอบเคลียร์ · แรงค์ Lv ═══════════════════
  {
    ...
    /* v7.4 · EXPLICIT LOOP COUNTER — คนที่ยังไม่วนรอบต้องโชว์ "(รอบที่ 0)" เสมอ
       ไม่ใช่ซ่อนวงเล็บทิ้งแบบ v7.2 (ครูแยกไม่ออกว่า "ยังไม่เคยวน" หรือ "ระบบนับไม่ทำงาน") */
    ok('คนที่ยังไม่วนรอบก็ยังโชว์ "(รอบที่ 0)"',
       /\(รอบที่ 0\)/.test(cells.find(c => c.u === 'a2').td[3]), cells.find(c => c.u === 'a2').td[3]);
